...
public class clickingBrushOrFlossAndroid {
    ...
    public void login() throws InterruptedException {
        ...
        Locator addChildBtn = page.locator("//button[normalize-space()='Add Your First Child']");
        Locator addChildIcon = page.locator("path[d='M11 11V5H13V11H19V13H13V19H11V13H5V11H11Z']");

        if (addChildBtn.isVisible()) {
            addChildBtn.click();
        } else {
            addChildIcon.click();
        }
        ...
        Assert.assertTrue(childCreatedName.contains(childName), "Child name is incorrect");
