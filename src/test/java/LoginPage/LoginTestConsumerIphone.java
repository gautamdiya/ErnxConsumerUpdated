...
static {
    ...
    public static void newLoginAddChild() throws InterruptedException {
        ...
        if (fname.isVisible()) {
            // creates a new account with a child
            fname.type("Test");
            surname.type("Tester");
    ...
    public static void oldUserLoginAddChild() throws InterruptedException {// old user add another child
        logger.info("Starting browser and Test Case");
        page.navigate("https://ernx-consumer.vercel.app/login");
        logger.info("Login Page Opened");
        page.getByPlaceholder("Email").type("automationtesttimechains@gmail.com");
